 ...
 * @package NcgovPdc
 */
class NoSuchGlobalKeyException extends NoSuchKeyException
{
    ...
    /**
     * Default constructor.
     * @param string $key the key which could not be returned.
    ...
    public function __construct($key, $message = '', $code = 0, $previous = null)
    {
        ...
        $this->message = sprintf(
            'Error: Extension global configuration key %s does not exist, you should define it first.',
            $key
        );
    }
}
